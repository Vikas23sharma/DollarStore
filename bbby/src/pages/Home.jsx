...
const Home = () => {
    return (
        <>
            <Box  marginTop={"5%"}>
                <Img margin="auto"  marginBottom={"2%"} width="95%" src='https://b3h2.scene7.com/is/content/BedBathandBeyond/FY22-FW52-US-0219-WEB-HP-C01-19-DSK-1?$content$&wid=2560&hei=1000' />
            </Box>
            <Flex marginTop={"4%"} marginBottom={"4%"}  style={{ width: "100%", justifyContent: "space-evenly", alignItems: "center" }}>
            ...
            <Box style={{ width: "90%", margin: "auto" }}>
                <Text color={"darkblue"}  fontSize="6xl">february savings spotlight</Text>
            ...
            <Box>
                <Img marginBottom={"2%"} width={"100%"} src='https://b3h2.scene7.com/is/image/BedBathandBeyond/FY22-FW52-US-0219-WEB-HP-C01-19-DSK-2?$content$&wid=1280&hei=350'></Img>
            </Box>
            <Flex marginBottom={"4%"} style={{ justifyContent: "space-between", width: "100%", }}>
            ...
            <Flex marginBottom={"4%"} style={{width:"100%",justifyContent:"space-evenly",alignItems:"center"}}>
                <Flex style={{flexDirection:"column"}}>
            ...
            <Flex marginBottom={"2%"}  width={"100%"} justifyContent={"space-evenly"}>
